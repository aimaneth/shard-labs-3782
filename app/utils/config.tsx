...
import { PortfolioActiveIcon, PortfolioInactiveIcon, TradingActiveIcon, TradingInactiveIcon, LeaderboardActiveIcon, LeaderboardInactiveIcon, MarketsActiveIcon, MarketsInactiveIcon, useScreen, Flex, cn, Button } from "@orderly.network/ui";
...
export const useOrderlyConfig = () => {
    ...
    mainNavProps.customRender = (components) => {
      ...
      return (
        <Flex
          justify="between"
          itemAlign="center"
          className="oui-w-full oui-h-full oui-px-4"
        >
          <Flex
            itemAlign="center"
          ...
          <Flex itemAlign="center" className="oui-gap-1 md:oui-gap-2">
            {!isHomePage && (
              <>
  ...
  }, [t, isMobile, location.pathname, navigate]);
};
